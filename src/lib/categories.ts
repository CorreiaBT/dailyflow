...
export const DEFAULT_EXPENSE_CATEGORIES: ExpenseCategoryDef[] = [
  { id: "coffee", label: "Café / Snack", emoji: "☕", isFlexible: true, monthlyBudgetLimit: 0 },
  { id: "food", label: "Alimentação", emoji: "🍔", isFlexible: true, monthlyBudgetLimit: 0 },
  { id: "transport", label: "Transporte", emoji: "🚗", isFlexible: true, monthlyBudgetLimit: 0 },
  { id: "emergency", label: "Farmácia", emoji: "💊", isFlexible: false, monthlyBudgetLimit: 0 },
  { id: "leisure", label: "Lazer", emoji: "🎟️", isFlexible: true, monthlyBudgetLimit: 0 },
];
